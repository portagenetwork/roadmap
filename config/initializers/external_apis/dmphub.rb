...
Rails.configuration.x.dmphub.client_id = '8888888' # Rails.configuration.x.dmproadmap.dmphub_client_id
Rails.configuration.x.dmphub.client_secret = '0987654321' # Rails.configuration.x.dmproadmap.dmphub_client_secret
