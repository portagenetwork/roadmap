...
- Reversed `perm_helper.rb` changes to reduce translation.io sync memory pressure and added rubocop exception for `translation.rb` [#188](https://github.com/portagenetwork/roadmap/issues/315)
