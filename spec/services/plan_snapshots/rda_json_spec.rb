  ...
  describe '#contact' do
    ...
    describe '#name' do
      it 'returns the contact name' do
        expect(contact_json['name']).to be_present
        expect(reader.contact.name).to eq(contact_json['name'])
      end
    end

    describe '#mbox' do
      it 'returns the contact email' do
        expect(contact_json['mbox']).to be_present
        expect(reader.contact.mbox).to eq(contact_json['mbox'])
      end
    end
    ...
    context 'when contact is absent' do
      ...
      it 'returns nil for affiliation name' do
        expect(reader.contact.name).to be_nil
        expect(reader.contact.mbox).to be_nil
